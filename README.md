...
The dependencies of this project are [ghdl](http://ghdl.free.fr/) and [gtkwave](http://gtkwave.sourceforge.net/). See
[here](https://github.com/kokkonisd/vhdl-template) for instructions on how to install them.
